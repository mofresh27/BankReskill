#Reskills_Banking_Backup.py

import random
import Banking_Data_Base
...
def register():
    ...
    #database[account_numbner] = firt


    acountNumber = generateAccountNum(accountNumber,[first_name, last_name, email, password,0])
    #accountDataBase[acountNumber]= [first_name, last_name, email, password]

    if is_user_created == Banking_Data_Base.create():
